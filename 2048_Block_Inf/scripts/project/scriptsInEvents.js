...
const scriptsInEvents = {
	...
	async Action_Event57_Act1(runtime, localVars)
	{
		 ...
		 ottwo:  for (let k = 0; k <  ArrayNumber[i].length-1; k++){    
		    ...
		    if(ArrayNum.getAt(i,k) > -1 ){	     
		       ...
		       if(ArrayNum.getAt(i,k) === ArrayNum.getAt(i,k+1) ){
				   ...
				   let s = k+1;
				   ArrayFind.push(i + "-" + k + "-" + ArrayNum.getAt(i,k) );  
				   ArrayFind.push(i + "-" + s + "-" + ArrayNum.getAt(i,k+1) );  
			       ...
			       if( s <= 3 ){	
				        ...
				        if(ArrayNum.getAt(i,k) === ArrayNum.getAt(i,k+2) ){
					       ...
					       ArrayFind.push(i + "-" + k + "-" + ArrayNum.getAt(i,k) );  
				           ArrayFind.push(i + "-" + h + "-" + ArrayNum.getAt(i,k+2) );  
		...
		outler:for (let i = 0; i < ArrayNumber[i].length; i++ ) {
		  ...
		  ottwo:  for (let k = 0; k <ArrayNumber.length-1; k++){
		     ...
		     if(ArrayNum.getAt(i,k) > -1  ){	 
		        ...
		        if(ArrayNum.getAt(i,k) === ArrayNum.getAt(i+1,k) ){
				   ...
				   let s = i+1;
				   ArrayFind.push(i + "-" + k + "-" + ArrayNum.getAt(i,k) );  
				   ArrayFind.push(s + "-" + k + "-" + ArrayNum.getAt(i+1,k) );  
				   ...
				   if( s <= 4 ){	   
					  ...
					  if(ArrayNum.getAt(i,k) === ArrayNum.getAt(i+2,k)){
					       ...
					       ArrayFind.push(i + "-" + k + "-" + ArrayNum.getAt(i,k));  
				           ArrayFind.push(h + "-" + k + "-" +  ArrayNum.getAt(i+2,k) );  
		...
		//alert(setarr); 
		 ...
		 let curfindOne_x, curfindOne_y, curfindTwo_x, curfindTwo_y, curfindThree_x, curfindThree_y, curfindOne_z, curfindTwo_z, curfindThree_z;   
		...
		//-------------------------------------------------------------------------------------------	 
		  	 ...
		  	 for (let i = 0; i < 1; i++){
			     ...
			     curfindOne_x = FindBlocksTwo[0];
			     curfindOne_y = FindBlocksTwo[1]; 		 
				 curfindOne_z =  FindBlocksTwo[2]; 	  		  
			 ...
			 for (let i = 2; i < 3; i++){
			    ...
			    let FindBlocksTwo = setarr[i].split('-'); 
				 ...
				 curfindThree_z =  FindBlocksTwo[2]; 		 
				   ...
				   for(let n=0; n<NumVar; n++){			 
					   ...
					   let FindAct = fr.instVars.Act_Find;
					    ...
					    if(curfindThree_z === curfindTwo_z && curfindThree_z === curfindOne_z ){
		...
		//-------------------------------------------------------------------------------------------		 
			...
			// если блоки справа-налево	 
			 ...
			 // если блоки только два равны слева-направо
			 }
			 
			 // если блоки только два равны
			}else if(curfindThree_z != curfindTwo_z && curfindThree_z != curfindOne_z){
