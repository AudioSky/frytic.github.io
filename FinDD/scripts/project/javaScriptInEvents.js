...
const scriptsInEvents = {
	...
	async Inventary_Event76_Act1(runtime, localVars)
	{
		...
		vkBridge.send('VKWebAppStorageSet', {
		  ...
		  console.log("safasdsdfsfsfsfsfsf" + coiiin);
		  
	},

	async Louder_Event3_Act2(runtime, localVars)
	{
		  ...
		  .then((data) => { 
		    if (data.keys[0].value) {
		       ...
		       runtime.globalVars.Coins = keys[0].value;
		       console.log("safasdf" + Coins);
	...
	async Inventary_Event1_Act2(runtime, localVars)
	{
		let fafgfsdg;
		   vkBridge.send('VKWebAppStorageGet', {
		  keys: [
		  ...
		  .then((data) => { 
		       ...
		       runtime.globalVars.Coins = keys[0].value;
		        fafgfsdg = keys[0].value;
		       console.log("safasdf + fafgfsdg " + fafgfsdg);
