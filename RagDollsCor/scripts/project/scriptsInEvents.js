...
const scriptsInEvents = {
	...
	async Action_Event316_Act2(runtime, localVars)
	{
		console.log(runtime.globalVars.Abd);
	},

	async Action_Event316_Act3(runtime, localVars)
	{
	...
	async Action_Event318_Act1(runtime, localVars)
	{
		console.log(runtime.globalVars.Abd);
	},

	async Action_Event322_Act8(runtime, localVars)
	{
		console.log(runtime.globalVars.ReklSound);
	},

	async Action_Event322_Act9(runtime, localVars)
	{
		console.log(runtime.globalVars.Abd);
	},
