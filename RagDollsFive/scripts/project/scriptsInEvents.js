...
const scriptsInEvents = {
	...
	async Action_Event311_Act3(runtime, localVars)
	{
		console.log(runtime.globalVars.Abd);
	},

	async Action_Event311_Act4(runtime, localVars)
	{
	...
	async Action_Event317_Act7(runtime, localVars)
	{
		console.log(runtime.globalVars.ReklSound);
	},

	async Action_Event317_Act8(runtime, localVars)
	{
		console.log(runtime.globalVars.Abd);
	},
