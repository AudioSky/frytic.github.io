...
const scriptsInEvents = {
	...
	async Louder_Event3_Act1(runtime, localVars)
	{
		let _c, _lev, _rud, _coinS, _levS, _rudS;
		...
		vkBridge.send('VKWebAppStorageGet', {
		  ...
		  .then((result) => { 
		       ...
		       _c = result.keys[0].value;
		      _lev = result.keys[1].value;
		      _rud = result.keys[2].value;
		...
		let _CoinsGet, _LevtGet, _HeroFaceGet, _FaceVikingGet, _FaceSoldierGet, _FacePirateGet, _FaceGladiator,
		    _GunOneTwo, _GunOneThree, _GunVikingTwo, _GunVikingThree, _GunSoldierTwo, _GunSoldierThree, _GunPirateTwo,
		    _GunPirateThree, _GunGladiatorTwo, _GunGladiatorThree;
		...
		vkBridge.send('VKWebAppStorageGet', {
		  ...
		  .then((result) => { 
		       ...
		       _CoinsGet = result.keys[0].value;
		       _LevtGet = result.keys[1].value;
		       _HeroFaceGet = result.keys[2].value;  
		       _FaceVikingGet = result.keys[3].value;
		       _FaceSoldierGet = result.keys[4].value; 
		       _FacePirateGet = result.keys[5].value; 
		       _FaceGladiator = result.keys[6].value; 
		       _GunOneTwo = result.keys[7].value;  
		       _GunOneThree = result.keys[8].value;  
		       _GunVikingTwo = result.keys[9].value; 
		       _GunVikingThree = result.keys[10].value; 
		       _GunSoldierTwo = result.keys[11].value; 
		       _GunSoldierThree = result.keys[12].value; 
		       _GunPirateTwo = result.keys[13].value;  
		       _GunPirateThree = result.keys[14].value;  
		       _GunGladiatorTwo = result.keys[15].value;  
		       _GunGladiatorThree = result.keys[16].value;   
		  ...
		  //=================================================
		      ...
		      if( _LevtGet.length != 0){
		           ...
		           console.log("непустой levt" + result.keys[1].value);
		      }else{
		           runtime.globalVars.levt = +_varEmpty[1];
		           console.log("пустой lev" + result.keys[1].value);;
		      }
		//=================================================
		      if(_HeroFaceGet != 0){
		...
		//=================================================
		 ...
		 //=================================================
		  ...
		  //=================================================
		      if(_GunVikingThree != 0){
		         runtime.globalVars.GunVikingThree = +_GunVikingThree;    
		      }else{
		         runtime.globalVars.GunVikingThree = +_varEmpty[0];
		      }
		   //=================================================
		      if(_GunSoldierTwo != 0){
	...
	async Inventary_Event79_Act2(runtime, localVars)
	{
	...
	async Inventary_Event265_Act4(runtime, localVars)
	{
	...
	async Inventary_Event268_Act4(runtime, localVars)
	{
	...
	async Inventary_Event271_Act4(runtime, localVars)
	{
	...
	async Inventary_Event274_Act4(runtime, localVars)
	{
		let _GunVikingThreeGt = +1;
		
		let _GunVikingThreeStr = _GunVikingThreeGt.toString();
	...
	async Inventary_Event277_Act4(runtime, localVars)
	{
	...
	async Inventary_Event280_Act4(runtime, localVars)
	{
	...
	async Inventary_Event283_Act4(runtime, localVars)
	{
	...
	async Inventary_Event286_Act4(runtime, localVars)
	{
	...
	async Inventary_Event289_Act4(runtime, localVars)
	{
	...
	async Inventary_Event292_Act4(runtime, localVars)
	{
	...
	async Inventary_Event370_Act1(runtime, localVars)
	{
